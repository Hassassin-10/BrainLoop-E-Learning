...
export const mockCourses: Course[] = [
  {
    ...
    modules: [
      { 
        ...
        url: 'https://youtu.be/ghCbURMWBD8?si=kvkv2U7ZplaNMzoA', 
  ...
  },
  {
    ...
    modules: [
      ...
      { 
        ...
        url: 'https://youtu.be/S7TUe5w6RHo?si=SpTM1N6kliryH_2U', 
  ...
  },
   {
    ...
    modules: [
      { 
        ...
        url: 'https://youtu.be/EGQh5SZctaE?si=ZjFLnIcI6OXp_VNC', 
